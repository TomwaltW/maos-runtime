...
| 2026-09-24 | p12 | **PAY-001 与 PAY-003 在「钱退回来一般要几天」上只差约 0.03**（0.749 对 0.723）：字符二元组分不开「要几天」（问政策）与「了吗」（问这一单） | 说法稍变就可能把政策问题转了人工；反方向（问状态被政策话术答掉）已由 T168 的测试钉住，这个方向没有 | p13 意图 / 槽位模型时收；或检索侧给「几天 / 多久」一类问政策的词加权（T168 口径，不归本轨） |
