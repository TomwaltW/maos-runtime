...
@pytest.mark.parametrize("text,want", [
    ...
    ("Ａ１００１", "A1001"),                                       # 全角：NFKC
    ("订单 #1001 能取消吗", "1001"),     # 「#」+ 数字 + 订单字眼（p15 T185：「#」是前缀，规范化去掉）
...
#: p16 task-t188（用户授权放开增补棘轮、并进 scenarios/cs/kb/additions_p16.json）照此重算：拿 bf53df6 的
#: scripts.py 原样，先在去掉 p16 增补的话术库上重算、逐条等于旧表（证明重算方法对），再在当前话术库上
#: 算出本表（53 轮里 44 轮的检索分随例句变了；复核轮撤掉 37 条增补后重算一次；见 docs/DECISIONS.md
#: task-t188）。
#: 整合期 p16：撤掉两条撞 p16 留出集的增补（DECISIONS integrate-p16）后重算了 15 轮的摘要。
P12_DEV_MATCH_DIGESTS_T173: dict[tuple[str, int], str] = {
    ("CS12-001", 1): "35bb636274f86a0a",
    ("CS12-002", 1): "71c2e2081b875aac",
    ("CS12-003", 1): "6b8394b88e261215",
    ("CS12-004", 1): "794d7bc97d0eb8a0",
    ("CS12-005", 1): "8827a70b97d2e37b",
    ("CS12-006", 1): "641b331e2cac7200",
    ("CS12-007", 1): "d9b49f2b319f9c3f",
    ("CS12-008", 1): "5a53a5690d97aae2",
    ("CS12-009", 1): "1cb0e25e391675be",
    ("CS12-010", 1): "1b36810ca4961989",
    ("CS12-011", 1): "1f850c1397d3d560",
    ("CS12-012", 1): "c66b0af85f246d8d",
    ("CS12-013", 1): "80a0c19ea5dd5d1c",
    ("CS12-014", 1): "2750d4282d7dd698",
    ("CS12-015", 1): "0b6a21aaf76c90c4",
    ("CS12-016", 1): "79ab53d06aeb93aa",
    ("CS12-017", 1): "9b324fb91d38f756",
    ("CS12-018", 1): "965e956e7c6bfa69",
    ("CS12-019", 1): "7a878398681be4cc",
    ("CS12-020", 1): "64488af1b1d6afa1",
    ("CS12-021", 1): "9b401167d5e5e75e",
    ("CS12-022", 1): "e11ed613aa0536bb",
    ("CS12-023", 1): "a040ef30fe50b30a",
    ("CS12-024", 1): "4d123959e7464588",
    ("CS12-025", 1): "52ca87d62c8b0013",
    ("CS12-026", 1): "d2d722bf74339c5a",
    ("CS12-027", 1): "061cd950e2ce2738",
    ("CS12-028", 1): "bcd5ad05581d629b",
    ("CS12-029", 1): "21e2523bd92d5f70",
    ("CS12-030", 1): "cd980dd8a8dfcc77",
    ("CS12-031", 1): "b8ca8275cc6a4678",
    ("CS12-032", 1): "f728881c816b1c51",
    ("CS12-033", 1): "f6f2faf486ab9200",
    ("CS12-034", 1): "bc91206538034f69",
    ("CS12-035", 1): "27a5a0c773d56766",
    ("CS12-036", 1): "8778604570971bc0",
    ("CS12-036", 2): "915f683da3637de9",
    ("CS12-036", 3): "fb47a65e2d5a0efa",
    ("CS12-037", 1): "edccfc5218b28cc1",
    ("CS12-037", 2): "f0c051d7fcad3ea2",
    ("CS12-038", 1): "45c5f12f46c9f9f0",
    ("CS12-038", 2): "d2d5ba7d31399deb",
    ("CS12-038", 3): "0897a4175229ace6",
    ("CS12-039", 1): "9612a0587bc894c5",
    ("CS12-039", 2): "905a94182c84ec9b",
    ("CS12-039", 3): "a2abff701cb3bfaa",
    ("CS12-040", 1): "ebb271040d3b33c9",
    ("CS12-041", 1): "124b644d5984f8db",
    ("CS12-042", 1): "1ac6bf5cba2917ea",
    ("CS12-043", 1): "dfb452cf9e3fdc6e",
    ("CS12-044", 1): "a8584b8010eb8d0d",
    ("CS12-045", 1): "c9bbd310f2fcf9a1",
    ("CS12-045", 2): "7e9e566796fab9b1",
}
...
def test_t168_holdout_under_the_hint_t173():
    ...
    # p16 task-t188：话术库并进声明增补后缺省检索 66 → 70、提示模式 69 → 72（本轨复核轮实测；首版 90 条时
    # 是 71 / 72，撤掉 37 条后缺省少检到一句）；提示的增益仍是 +2，另钉两个绝对数，只许抬。
    # 整合期 p16：撤掉两条撞 p16 留出集的增补后缺省检索 70 → 71、提示模式仍 72，增益从 +2 变 +1；
    # 两个绝对数的地板照旧（缺省 ≥ 70、提示 ≥ 72），增益改钉「提示不比缺省差、且至少 +1」。
    assert hinted >= plain + 1 and plain >= 70 and hinted >= 72, (plain, hinted)
