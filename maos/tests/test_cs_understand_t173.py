...
#: 算出本表（53 轮里 45 轮的检索分随例句变了；见 docs/DECISIONS.md task-t188）。
P12_DEV_MATCH_DIGESTS_T173: dict[tuple[str, int], str] = {
    ("CS12-001", 1): "505a4d0be50e0dc3",
    ("CS12-002", 1): "dba3c5dc0a72a5bd",
    ("CS12-003", 1): "fae98203106198da",
    ("CS12-004", 1): "fc807d064ea63127",
    ("CS12-005", 1): "cba03401266c8609",
    ("CS12-006", 1): "1c3dd72af242602b",
    ("CS12-007", 1): "1a7a9f7a9fefbc05",
    ("CS12-008", 1): "020948f49e3012f0",
    ("CS12-009", 1): "be8ee4568df2d674",
    ("CS12-010", 1): "cb0532300f1230d9",
    ("CS12-011", 1): "1f850c1397d3d560",
    ("CS12-012", 1): "2523cbc6000d2b97",
    ("CS12-013", 1): "bdb6643574c2bf0f",
    ("CS12-014", 1): "2b40df310ba0ef05",
    ("CS12-015", 1): "0c43657694713fdf",
    ("CS12-016", 1): "4c67fe5b940540f0",
    ("CS12-017", 1): "7da6db87574cf952",
    ("CS12-018", 1): "87c6fe00766d7c1d",
    ("CS12-019", 1): "6e49d4745cc62c4b",
    ("CS12-020", 1): "937966fd9a0e6e22",
    ("CS12-021", 1): "9b401167d5e5e75e",
    ("CS12-022", 1): "66eba835f54d3ace",
    ("CS12-023", 1): "a040ef30fe50b30a",
    ("CS12-024", 1): "4d123959e7464588",
    ("CS12-025", 1): "5b8801b5bb25a3ec",
    ("CS12-026", 1): "ece03c39d8b76d5b",
    ("CS12-027", 1): "4d51d4c4f5a36f6f",
    ("CS12-028", 1): "d53c1fef15694d83",
    ("CS12-029", 1): "6be738a4549048c0",
    ("CS12-030", 1): "cd980dd8a8dfcc77",
    ("CS12-031", 1): "d5f8f33ee76e7f93",
    ("CS12-032", 1): "f728881c816b1c51",
    ("CS12-033", 1): "f6f2faf486ab9200",
    ("CS12-034", 1): "217611f31302ce82",
    ("CS12-035", 1): "2330978c99b8a00b",
    ("CS12-036", 1): "8778604570971bc0",
    ("CS12-036", 2): "e64478e752a18fc1",
    ("CS12-036", 3): "ce6fe7f19a19ba04",
    ("CS12-037", 1): "de510302dfcdeb8d",
    ("CS12-037", 2): "f0c051d7fcad3ea2",
    ("CS12-038", 1): "c25c28b0cfb4a2ae",
    ("CS12-038", 2): "b9f7f274c1c9c1c5",
    ("CS12-038", 3): "1d3609988c48bf67",
    ("CS12-039", 1): "36b0c3c190a79da0",
    ("CS12-039", 2): "905a94182c84ec9b",
    ("CS12-039", 3): "a2abff701cb3bfaa",
    ("CS12-040", 1): "e79da0b9389e9c0e",
    ("CS12-041", 1): "6bb4e46103fb5559",
    ("CS12-042", 1): "07b3cdedfd20ef7f",
    ("CS12-043", 1): "5a4396630260b9a9",
    ("CS12-044", 1): "999689def7033f29",
    ("CS12-045", 1): "c9bbd310f2fcf9a1",
    ("CS12-045", 2): "5207951d44f429d9",
}
...
def test_t168_holdout_under_the_hint_t173():
    ...
    # p16 task-t188：话术库并进声明增补后缺省检索 66 → 71、提示模式 69 → 72（本轨实测） —— 缺省抬得比提示多
    # （提示原先补回的几句，现在缺省自己就检得到），提示的增益从 +2 收成 +1；两个绝对数只许抬。
    assert hinted >= plain + 1 and plain >= 71 and hinted >= 72, (plain, hinted)
