...
| `code.repo-patch` | `1.0.0` | 软件交付域 | `coding` | escalate | `git-mcp`、`sandbox` | `maos/skills/builtin/code_repo_patch.py:153` |
...
实现：`CodeRepoPatchSkill` @ `maos/skills/builtin/code_repo_patch.py:153`
